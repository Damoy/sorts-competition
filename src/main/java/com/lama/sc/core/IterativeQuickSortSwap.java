 ...
 */
public class IterativeQuickSortSwap implements ISort {

	private final static ISort INSTANCE = new IterativeQuickSortSwap();

	private IterativeQuickSortSwap() {
	}
