...
public class ApplicationSlide4Iterative {
	...
	private static void quicksFlat(int times){
		...
		String scenarioTitle = "Comparing quick sorts pivots - it - flat - pow";
		...
		input(scenarioBuilder, "Quick", IterativeQuickSort.getInstance(), dataset2pow5, dataset2pow6,
				dataset2pow7, dataset2pow8, dataset2pow9, dataset2pow10, dataset2pow11, dataset2pow12);
		
		input(scenarioBuilder, "Quick3", IterativeQuickSort3.getInstance(), dataset2pow5, dataset2pow6,
				dataset2pow7, dataset2pow8, dataset2pow9, dataset2pow10, dataset2pow11, dataset2pow12);
		
		input(scenarioBuilder, "Quick5", IterativeQuickSort5.getInstance(), dataset2pow5, dataset2pow6,
				dataset2pow7, dataset2pow8, dataset2pow9, dataset2pow10, dataset2pow11, dataset2pow12);
		
		input(scenarioBuilder, "QuickRand", IterativeQuickSortRandom.getInstance(), dataset2pow5, dataset2pow6,
				dataset2pow7, dataset2pow8, dataset2pow9, dataset2pow10, dataset2pow11, dataset2pow12);
	...
	private static void quicksReversed(int times){
		IGenerator generator = Generator.getInstance();
		String scenarioTitle = "Comparing quick sorts pivots - it - reversed - pow";
	...
	private static void quicksSorted(int times){
		IGenerator generator = Generator.getInstance();
		String scenarioTitle = "Comparing quick sorts pivots - it - sorted - pow";
	...
	private static void quicksRandom(int times, EnumRandomGenerationBound bound){
		IGenerator generator = Generator.getInstance();
		String scenarioTitle = "Comparing quick sorts pivots - it - random - pow";
