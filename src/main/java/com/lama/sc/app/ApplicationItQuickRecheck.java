...
public class ApplicationItQuickRecheck {

	public static void main(String[] args) {
		// itquickrand(100, EnumRandomGenerationBound.N);
		itquickFlat(100);
	}
	
	private static void itquickrand(int times, EnumRandomGenerationBound bound){
		IGenerator generator = Generator.getInstance();
		String scenarioTitle = "CheckItQuickSort - rand - pow"; // (" + bound + ")";
		...
		input(scenarioBuilder, "IterativeQuickSort", IterativeQuickSort.getInstance(), dataset2pow5, dataset2pow6,
	...
	private static void itquickFlat(int times){
		IGenerator generator = Generator.getInstance();
		String scenarioTitle = "CheckItQuickSort - flat - pow"; // (" + bound + ")";
